...
## Citing Individual Frameworks

### APA — Named Framework
EL-Dharrat, M. (2026). *[Framework Name]* [Framework GI-00X]. In *Beyond AI disruption* (Chapter X). Esync Deep Ltd.

### Examples

**Guardrail Innovation (GI-001):**
EL-Dharrat, M. (2026). *Guardrail Innovation* [GI-001]. In *Beyond AI disruption* (Chapter 3). Esync Deep Ltd.

**Trust Curve (GI-002):**
EL-Dharrat, M. (2026). *Trust Curve* [GI-002]. In *Beyond AI disruption* (Chapter 5). Esync Deep Ltd.

**Guardrail Cycle (GI-003):**
EL-Dharrat, M. (2026). *Guardrail Cycle* [GI-003]. In *Beyond AI disruption* (Chapter 4). Esync Deep Ltd.

**Stabilization Index (GI-004):**
EL-Dharrat, M. (2026). *Stabilization Index* [GI-004]. In *Beyond AI disruption* (Chapter 7). Esync Deep Ltd.

**Regulatory Moat (GI-005):**
EL-Dharrat, M. (2026). *Regulatory Moat* [GI-005]. In *Beyond AI disruption* (Chapter 6). Esync Deep Ltd.

---

## Citing the Living Document Specification
...
### Academic Citation for the Specification

EL-Dharrat, M. (2026). *The Living Document Specification (v1.0)* [Open-source publishing standard]. Esync Deep Ltd. CC BY 4.0.
